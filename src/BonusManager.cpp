...
std::shared_ptr <Bonus> bonus;
    ...
    case 0:
        bonus = std::make_shared <LongerBarBonus>(pos,
                _textures[0]);
        break;
    case 1:
        bonus = std::make_shared <BallSpeedUpBonus>(pos,
            _textures[1]);
        break;
    case 2:
        bonus = std::make_shared <StickToBarBonus>(pos,
            _textures[2]);
        break;
    case 3:
        ...
        break;
    case 4:
        bonus = std::make_shared <ChangeBallDirBonus>(pos,
            _textures[4]); 
        break;
    case 5:
